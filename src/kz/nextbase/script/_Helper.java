...
public class _Helper {
	...
	public static Date[] getPeriodDates(_PeriodType pType, boolean sixWorkDays, String currentYear){
		int cy = 0;
		try{
		...
		Calendar c[] = RuntimeObjUtil.getPeriodDates(pType, sixWorkDays, new HolidayCollection(cy));
		Date[] day = new Date[c.length];

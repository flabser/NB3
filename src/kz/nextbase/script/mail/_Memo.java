...
public class _Memo {
	...
	public _Memo(String subject, String bodyTitle, String b, _Document doc, boolean considerLang)
		...
		body += "</tr></table>";
		if (doc != null) {
			body += "<p><font size=\"2\" face=\"Arial\">Для просмотра перейдите по <a href=\"" + doc.getFullURL()
					+ "\">ссылке...</a></p></font>";
		}
	}

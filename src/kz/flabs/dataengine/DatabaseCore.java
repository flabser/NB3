...
public abstract class DatabaseCore {
    ...
    protected static final String[] systemFields = {"docid", "doctype", "author", "parentdocid", "parentdoctype", "regdate", "lastupdate", "viewtext", "viewtext1", "viewtext2", "viewtext3", "viewtext4", "viewtext5", "viewtext6", "viewtext7", "viewnumber", "viewdate", "viewicon", "form", "syncstatus", "has_attachment"};
    ...
    protected String getViewContent(ResultSet rs) throws SQLException {
        ...
        return "<viewcontent>" + viewcontent.toString() + "<viewdate>" + (tempDate != null ? Database.dateTimeFormat.format(tempDate) : "") + "</viewdate></viewcontent>";
    }
    ...
    /*	if (fillViewText(rs, "VIEWTEXT", doc)){
			if (fillViewText(rs, "VIEWTEXT1", doc)){
				if (fillViewText(rs, "VIEWTEXT2", doc)){

...
public class QueryFormula implements IQueryFormula {
    ...
    public String getSQL(Set<String> complexUserID, int pageSize, int offset, String[] filters, String[] sorting) {
        ...
        //sql += "foo.count, " + fieldsSQLpart + " FROM " + fromSQLpart + whereSQLpart;
        sql += "foo.count as totalcount, " + fieldsSQLpart + " FROM " + fromSQLpart + ", (select count( " + fieldsSQLpart + ") from " + fromSQLpart + whereSQLpart + ") as foo " + whereSQLpart;

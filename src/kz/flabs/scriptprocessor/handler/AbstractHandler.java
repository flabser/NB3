...
public abstract class AbstractHandler extends ScriptEvent implements IHandlerScript {
	...
	private File file;
	private XMLResponse xmlResp = new XMLResponse(ResponseType.RESULT_OF_HANDLER_SCRIPT);
	...
	public void showFile(File file){
		this.file = file;
		xmlResp = new XMLResponse(ResponseType.SHOW_FILE_AFTER_HANDLER_FINISHED);
